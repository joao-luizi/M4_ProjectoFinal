        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InformationAuthorized = table.Column<bool>(type: "bit", nullable: false),
                    ImageAuthorized = table.Column<bool>(type: "bit", nullable: false),
                    RegisterDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    TaxIdentificationNumber = table.Column<int>(type: "int", nullable: false),
                    SocialHealthNumber = table.Column<long>(type: "bigint", nullable: false),
                    CitizenNumber = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EMUser", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserPhotos_EMUser_UserId",
                        column: x => x.UserId,
