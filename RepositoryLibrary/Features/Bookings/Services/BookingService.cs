...
public class BookingService : IBookingService
{
    ...
    {
        DateTime startOfWeek1 = date1.Date.AddDays(-(date1.DayOfWeek == DayOfWeek.Sunday ? 6 : date1.DayOfWeek - DayOfWeek.Monday));
        DateTime startOfWeek2 = date2.Date.AddDays(-(date2.DayOfWeek == DayOfWeek.Sunday ? 6 : date2.DayOfWeek - DayOfWeek.Monday));
